...
class App extends Component {
    constructor() {
        ...
        this.foodClasses = ["blueberry", "cherry", "grapes", "raspberry", "strawberry"];
        this.turningPoints = [];
        this.boardWidth = 20;
        this.boardHeight = 15;
        this.snakeDelay = 100;
        ...
        this.eatAudio = new Audio(eatSound);
    ...
    keyListner(event) {
        ...
        switch (keyCode) {
            case 38:
                if (tempSnake.head.direction === "T" || tempSnake.head.direction === "B") return;
            ...
            case 39:
                if (tempSnake.head.direction === "R" || tempSnake.head.direction === "L") return;
            ...
            case 40:
                if (tempSnake.head.direction === "B" || tempSnake.head.direction === "T") return;
            ...
            case 37:
                if (tempSnake.head.direction === "L" || tempSnake.head.direction === "R") return;
    ...
    onSwipeMove(position, event) {
        ...
        if (this.allowSwipe) {
            if (Math.abs(x) > tolerance || Math.abs(y) > tolerance) {
                ...
                if (Math.abs(y) > Math.abs(x)) this.keyListner({ keyCode: y > 0 ? 40 : 38 });
    ...
    render() {
        return (
            ...
            >
                <Swipe className="full-height flex flex-center" onSwipeMove={this.onSwipeMove}>
                    <div className="container">
                        ...
                        {this.state.gameMenuDisplay && (
                            <div className="border menu-overlay mt-2">
                                <div className="flex flex-center">
                                    ...
                                    <div className="game-over-text">SELECT ONE</div>
                        ...
                        {this.state.gameOverDisplay && (
                            <div className="border gameover-overlay mt-2">
                                ...
                                <div className="flex mt-2">
                                    <span onClick={this.endGame} className="snakeButton mr-1 ml-1">
                                        RESTART
                                    </span>
                                </div>
                            </div>
